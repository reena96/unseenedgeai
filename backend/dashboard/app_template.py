...
def main():
                    ...
                    with st.expander(
                        ...
                        if evidence:
                            for idx, ev in enumerate(evidence[:5], 1):  # Top 5
                                st.markdown(
                                    f"**{idx}. {ev.get('source', 'Unknown Source')}** (Relevance: {ev.get('relevance', 0):.2f})"
                                )
    ...
    # ========================================================================
        ...
        st.info(
            "📊 Historical data tracking coming soon! This will show skill progress over weeks/months."
        )
